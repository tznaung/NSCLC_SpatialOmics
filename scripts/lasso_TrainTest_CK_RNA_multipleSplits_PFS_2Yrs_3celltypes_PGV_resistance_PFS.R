...
write.csv(cell_genes, "cellgenes_resistance.csv")
...
for (cSplit in 1:nModels){
  ...
  write.csv(response$table, "CK_train_set_Sig_Genes_PFS.csv")
  ...
  ## ADD
  fname_out = paste("hzrs_CK_PFS_5Years_3celltypes_resistance_P_G_V_CW_genes.csv",sep="")
